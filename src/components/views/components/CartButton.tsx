...
export const CartButton: React.FC<CartButtonProps> = ({ itemCount, total, onOpenCart }) => {
    return (
        <div className="fixed bottom-6 right-6 left-6 md:left-auto md:w-96 z-40">
            <button 
                onClick={onOpenCart}
                className="w-full bg-neutral-900 dark:bg-white text-white dark:text-black py-2 px-4 rounded-2xl shadow-2xl flex justify-between items-center font-bold text-lg animate-in slide-in-from-bottom-4 hover:shadow-3xl transition-shadow"
            >
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-base sm:text-sm">View Order</span>
                </div>
