...
export const CategoryHeader: React.FC<CategoryHeaderProps> = ({ category, isActive }) => {
    ...
    return (
        <div className="flex items-center gap-4 p-4">
            <div className={`w-12 h-12 rounded-full bg-gradient-to-br from-gold-100 to-gold-200 dark:from-gold-900/30 dark:to-gold-800/30 flex items-center justify-center transition-all duration-300 ${
                isActive 
