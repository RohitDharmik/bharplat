    ...
    return (
        <div className="pb-24">
            ...
            <div className="mb-6 flex justify-between items-center">
                <div>
                    <h2 className="text-3xl font-bold text-neutral-900 dark:text-white">Menu</h2>
                    ...
                    {cart.map(item => (
                        <div key={item.menuItemId} className="flex justify-between items-center py-3 border-b border-neutral-100 dark:border-white/5">
                            ...
                            <div className="flex items-center gap-3 bg-neutral-100 dark:bg-neutral-800 rounded-lg p-1">
                                <button onClick={() => updateQuantity(item.menuItemId, -1)} className="p-1 hover:bg-white dark:hover:bg-white/10 rounded"><span className="text-sm">−</span></button>
