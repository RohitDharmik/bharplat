...
import { 
  ScanLine, ChevronRight, Play, BarChart3, ChefHat, 
  Users, Smartphone, ShieldCheck, Zap, Star, Menu, X, ArrowRight 
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-gold-500/30">
      ...
      <nav className="fixed w-full z-50 bg-[#0a0a0a]/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="text-2xl font-bold tracking-tighter flex items-center gap-2">
            ...
            <span>BHAR<span className="text-gold-500">PLATE</span></span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold leading-[1.1] tracking-tight">
              PRECISION <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-neutral-500">MANAGEMENT</span> <br/>
              FOR DINING
            </h1>
            <p className="text-lg text-neutral-400 max-w-xl leading-relaxed">
              Streamline reservations, KOTs, and table service to elevate your customer dining profile, speed, and bottom line. The operating system for modern restaurants.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <button onClick={() => setIsLoginModalOpen(true)} className="px-8 py-4 bg-gold-500 hover:bg-gold-400 text-black font-bold rounded-xl flex items-center justify-center gap-2 transition-all">
                START FREE TRIAL
                <ArrowRight size={20} />
              </button>
               ...
               <div className="p-6 grid grid-cols-2 gap-6">
                  <div className="space-y-4">
                     <div className="h-32 bg-gold-500/10 rounded-xl border border-gold-500/20 p-4 relative overflow-hidden">
                        <BarChart3 className="text-gold-500 absolute bottom-4 right-4" size={48} />
                  ...
                  <div className="space-y-4">
                     ...
                     <div className="h-48 bg-white/5 rounded-xl p-4">
                        <div className="space-y-3">
                           {[1,2,3].map(i => <div key={i} className="h-2 w-full bg-white/10 rounded-full"></div>)}
                        </div>
                     </div>
                  </div>
               </div>
          ...
          {[
            ...
            { label: 'Customer Support', value: '24/7' },
             ...
             <div key={i} className="text-center md:text-left">
                ...
                <p className="text-sm text-gold-500 font-bold tracking-wider uppercase">{stat.label}</p>
             </div>
          ))}
        </div>
      </div>
      ...
      <section id="features" className="py-24 max-w-7xl mx-auto px-6">
         <div className="text-center mb-16 space-y-4">
            <h2 className="text-gold-500 font-bold tracking-widest uppercase text-sm">Features Overview</h2>
            <h3 className="text-3xl md:text-5xl font-bold text-white">ENGINEERED FOR EXCELLENCE</h3>
         </div>

         <div className="grid md:grid-cols-3 gap-8">
            {[
               { icon: Users, title: 'Table Management', desc: 'Visualize your floor plan in real-time. Assign seats, track occupancy, and turn tables faster.' },
               { icon: Smartphone, title: 'Digital Ordering', desc: 'QR-based menus allow guests to order instantly. Reduce waiter workload and errors.' },
               { icon: ChefHat, title: 'Kitchen Display', desc: 'Direct-to-kitchen firing with detailed KOTs. Track prep times and eliminate paper tickets.' },
            ].map((feature, i) => (
               <div key={i} className="bg-neutral-900/50 border border-white/10 p-8 rounded-2xl hover:bg-neutral-800/50 hover:border-gold-500/30 transition-all group">
      ...
      <section className="py-24 bg-neutral-900/30 border-y border-white/5">
         <div className="max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-center">
               <div className="space-y-8">
                  <h3 className="text-3xl font-bold text-white">Seamless Operations<br/>From Front to Back</h3>
                  <div className="space-y-6">
                     {[
                        { title: 'Smart Reservations', desc: 'AI-driven booking management that maximizes seating capacity.' },
                        { title: 'Financial Analytics', desc: 'Real-time revenue tracking, expense reports, and tax automation.' },
                        { title: 'Role-Based Access', desc: 'Granular permissions for Admins, Managers, Chefs, and Waiters.' },
                        { title: 'Multi-Device Sync', desc: 'Works flawlessly across Tablets, Mobiles, and Desktop POS.' }
                     ].map((item, i) => (
               ...
               <div className="grid grid-cols-2 gap-4">
                  <div className="bg-[#121212] p-6 rounded-2xl border border-white/5 h-64 flex flex-col justify-end">
                      ...
                      <p className="text-xs text-neutral-500">Data-driven decisions</p>
                  </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
         <h2 className="text-center text-3xl font-bold text-white mb-16">INDUSTRY LEADERS CHOOSE US</h2>
         <div className="grid md:grid-cols-3 gap-8">
            {[
               { name: 'Arjun Mehta', role: 'Owner, Spice Route', quote: 'Since switching to BharPlate, our table turnover rate improved by 25%. The kitchen display system is a game changer.' },
               { name: 'Sarah Jenkins', role: 'Manager, The Lofr', quote: 'The financial reporting tools saved us hours of manual work every week. Highly recommended.' },
               { name: 'Vikram Singh', role: 'Head Chef, Urban Tandoor', quote: 'KOTs are instant and accurate. No more confusion in the kitchen during rush hours.' }
            ].map((testi, i) => (
               <div key={i} className="bg-neutral-900/40 p-8 rounded-2xl border border-white/5">
         ...
         <div className="max-w-7xl mx-auto px-6">
            <div className="bg-gold-500 rounded-3xl p-12 text-center mb-20 relative overflow-hidden">
               ...
               <div className="relative z-10">
                  <h2 className="text-4xl font-bold text-black mb-6">READY TO ELEVATE?</h2>
                  <p className="text-black/70 mb-8 max-w-xl mx-auto font-medium">Join hundreds of restaurants modernizing their workflow today.</p>
                  <div className="flex justify-center gap-4">
                     <button onClick={() => setIsLoginModalOpen(true)} className="px-8 py-3 bg-black text-white font-bold rounded-xl hover:bg-neutral-800 transition-colors">
                        Get Started Now
                     </button>
            ...
            <div className="grid md:grid-cols-4 gap-12 text-sm text-neutral-400 border-b border-white/10 pb-12 mb-12">
               <div className="col-span-1 md:col-span-1">
                  <div className="text-2xl font-bold text-white mb-4">BHAR<span className="text-gold-500">PLATE</span></div>
               ...
               <div>
                  ...
                  <ul className="space-y-2">
                     ...
                     <li><a href="#" className="hover:text-gold-500">Hardware</a></li>
                  </ul>
               </div>
               <div>
      ...
      {/* Login Modal */}
      <ConfigProvider theme={{ algorithm: theme.darkAlgorithm, token: { colorBgElevated: '#1E1E1E', borderRadiusLG: 16 } }}>
        <Modal
        ...
        >
          <div className="p-6">
              ...
              <p className="text-neutral-400 text-center mb-8 text-sm">Select your role to access the dashboard</p>
              ...
              <div className="relative py-6">
                ...
                <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#1E1E1E] px-2 text-neutral-500">Or</span></div>
              </div>
